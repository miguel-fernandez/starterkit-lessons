...
```bash
lb-dev --name DaVinciDev DaVinci/v46r4
```
...
```bash
lb-glimpse "PVRefitter" DaVinci/v46r4
```
...
For example, the doxygen documentation for DaVinci v46r4 is
[here](http://lhcbdoc.web.cern.ch/lhcbdoc/davinci/releases/Run1and2/v46r4/).
