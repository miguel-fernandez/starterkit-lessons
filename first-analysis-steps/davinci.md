...
This will run the `gaudirun.py` command using version v46r4 of DaVinci. (`lb-run` sets the specified environment for `gaudirun.py` to run in.)
`gaudirun.py` is a script that sets up the EventLoop.
You should get the following output:

```
====================================================================================================================================
                                                   Welcome to DaVinci version 46.4
                                          running on lxplus774.cern.ch on Mon Dec 12 11:32:26 2022
====================================================================================================================================
...
```bash
lb-run DaVinci/v46r4 gaudirun.py options1.py options2.py
```
...
These lessons use [DaVinci v46r4][v46r4], which was the latest Run 1/2 version at the
time the text was last revised.

[releases]: http://lhcbdoc.web.cern.ch/lhcbdoc/davinci/releases/
[v46r4]: http://lhcbdoc.web.cern.ch/lhcbdoc/davinci/releases/v46r4/
...
```bash
lb-run DaVinci/v46r4 bash --norc
```
...
For most purposes, `SetupProject DaVinci v46r4` is equivalent to
```bash
lb-run DaVinci/v46r4 $SHELL
```
but you should really avoid doing things this way as this method is no longer supported for the latest project releases. (The environment for DaVinci v46r4, for example, cannot be started this way.)
